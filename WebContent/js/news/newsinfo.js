...
//==================一个table实例================================
	  table.render({
	    ...
	    cols: [[ //表头
	      ...
	      ,{field: 'user_id', title: '作者',align:'center' }
	      ,{field: 'create_time', title: '编写时间',align:'center' }
	      ...
	      ,{field: 'reading', title: '阅读者',align:'center' }
	  ...
	  if(layEvent === 'check'){ //查看
		 ...
		 //关闭当前提示	
		  ...
		  var index = layui.layer.open({
              ...
              skin: 'layui-layer-lan',
              area: ['800px', '600px'],
              content : "openNewsEdit?id="+data.id,
              success : function(layero, index){
                  setTimeout(function(){
                      layui.layer.tips('点击此处返回列表', '.layui-layer-setwin .layui-layer-close', {
                          tips: 3
