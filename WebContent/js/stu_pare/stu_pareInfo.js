...
//==================一个table实例================================
	var ins=  table.render({
	    ...
	    cols: [[ //表头
		      ...
		      ,{field: 'stu_id', title: '学生姓名',width:150}
		      ,{field: 'pare_id' ,title:'家长姓名',width:150}
		      ,{field: 'relation' ,title:'关系',width:150}
	  ...
	  if(layEvent === 'check'){
		 ...
		 //关闭当前提示	
		  ...
		  var index = layui.layer.open({
              title : "修改信息",
              type : 2,
              content : "openStu_pareEdit?id="+data.id,
              success : function(layero, index){
                  setTimeout(function(){
                      layui.layer.tips('点击此处返回列表', '.layui-layer-setwin .layui-layer-close', {
                          tips: 3
