...
//==================一个table实例================================
	var ins=  table.render({
	    ...
	    cols: [[ //表头
		      ...
		      ,{field: 'nickname', title: '名称',width:150}
		      ,{field: 'addr' ,title:'教室地址',width:150}
		      ,{field: 'status' ,title:'状态',width:150,
		    	  templet:function(d){
		    		  if(d.status==0){
		    			  return '<span class="layui-badge layui-bg-blue">空闲</span>'
		    		  } 
		    		  else if(d.status==1){
		    			  return '<span class="layui-badge layui-bg-orange">占用</span>'
		    		  }
		    		  else{
